...
namespace Admiral.ERP.Web.Template {
    ...
    public partial class FlowChartNaviationVerticalTemplateContent {
        
        /// <summary>
        /// UPPopupWindowControl 控件。
        /// </summary>
        /// <remarks>
        /// 自动生成的字段。
        ...
        /// <summary>
        /// FlowChartNavigation 控件。
        /// </summary>
        /// <remarks>
        /// 自动生成的字段。
        /// 若要进行修改，请将字段声明从设计器文件移到代码隐藏文件。
        /// </remarks>
        protected global::Admiral.ERP.Web.Template.FlowChartNavigation FlowChartNavigation;
